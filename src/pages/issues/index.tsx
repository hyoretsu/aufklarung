...
const Archives: React.FC = () => {
 return (
  <>
   ...
   <Section>
    <Link href="/issues/19">
     <Image src={Cover19} alt="Capa da edição" width={455} height={614} />
    </Link>
    <div>
     <h4>
   ...
   <Section>
    <Link href="/issues/18">
     <Image src={Cover18} alt="Capa da edição" width={455} height={614} />
    </Link>
    <div>
     <h4>
   ...
   <Section>
    <Link href="/issues/17">
     <Image src={Cover17} alt="Capa da edição" width={455} height={614} />
    </Link>
    <div>
     <h4>
      <Link href="/issues/17">
   ...
   <Section>
    <Link href="/issues/16">
     <Image src={Cover16} alt="Capa da edição" width={455} height={614} />
    </Link>
    <div>
     <h4>
   ...
   <Section>
    <Link href="/issues/15">
     <Image src={Cover15} alt="Capa da edição" width={455} height={614} />
    </Link>
    <div>
     <h4>
   ...
   <Section>
    <Link href="/issues/14">
     <Image src={Cover14} alt="Capa da edição" width={455} height={614} />
    </Link>
    <div>
     <h4>
   ...
   <Section>
    <Link href="/issues/13">
     <Image src={Cover13} alt="Capa da edição" width={455} height={614} />
    </Link>
    <div>
     <h4>
   ...
   <Section>
    <Link href="/issues/12">
     <Image src={Cover12} alt="Capa da edição" width={455} height={614} />
    </Link>
    <div>
     <h4>
   ...
   <Section>
    <Link href="/issues/11">
     <Image src={Cover11} alt="Capa da edição" width={455} height={614} />
    </Link>
    <div>
     <h4>
   ...
   <Section>
    <Link href="/issues/10">
     <Image src={Cover10} alt="Capa da edição" width={455} height={614} />
    </Link>
    <div>
     <h4>
      <Link href="/issues/10">
   ...
   <Section>
    <Link href="/issues/9">
     <Image src={Cover9} alt="Capa da edição" width={455} height={614} />
    </Link>
    <div>
     <h4>
   ...
   <Section>
    <Link href="/issues/8">
     <Image src={Cover8} alt="Capa da edição" width={455} height={614} />
    </Link>
    <div>
     <h4>
      <Link href="/issues/8">
   ...
   <Section>
    <Link href="/issues/7">
     <Image src={Cover7} alt="Capa da edição" width={455} height={614} />
    </Link>
    <div>
     <h4>
   ...
   <Section>
    <Link href="/issues/6">
     <Image src={Cover6} alt="Capa da edição" width={455} height={614} />
    </Link>
    <div>
     <h4>
   ...
   <Section>
    <Link href="/issues/5">
     <Image src={Cover5} alt="Capa da edição" width={455} height={614} />
    </Link>
    <div>
     <h4>
   ...
   <Section>
    <Link href="/issues/4">
     <Image src={Cover4} alt="Capa da edição" width={455} height={614} />
    </Link>
    <div>
     <h4>
   ...
   <Section>
    <Link href="/issues/3">
     <Image src={Cover3} alt="Capa da edição" width={455} height={614} />
    </Link>
    <div>
     <h4>
   ...
   <Section>
    <Link href="/issues/2">
     <Image src={Cover2} alt="Capa da edição" width={455} height={614} />
    </Link>
    <div>
     <h4>
   ...
   <Section>
    <Link href="/issues/">
     <Image src={Cover1} alt="Capa da edição" width={455} height={614} />
    </Link>
    <div>
     <h4>
