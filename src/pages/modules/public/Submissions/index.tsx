...
import { Styling, Conditions, Guidelines, Section } from './styles';
 ...
 return (
  <DefaultTemplate>
   ...
   <Styling>
    <div>
     <p>
      <a href="https://periodicos.ufpb.br/ojs2/index.php/arf/submission/wizard">Fazer nova submissão</a> ou{' '}
      <a href="https://periodicos.ufpb.br/ojs2/index.php/arf/submissions">ver suas submissões pendentes</a>.
     </p>
    </div>
    <Conditions>
     ...
     <ol>
      ...
      <li>
       <span>
        ...
        <Link to="#diretrizes">Diretrizes para Autores</Link>.
       </span>
      </li>
      <li>
       <span>
        ...
        disponíveis em{' '}
        <a href="https://seer.ufrgs.br/index.php/ambienteconstruido/help/view/editorial/topic/000044">
    ...
    <Guidelines id="diretrizes">
     ...
     <ol>
      ...
      <li>
       ...
       <p>
        Os manuscritos serão avaliados pelo processo de avaliação cega dupla pelos pares (double blind peer review). Os
       ...
       <ol>
        ...
        <li>
         ...
         <ul>
          ...
          <li>
           <i>
            <strong>Tabalho apresentado em congressos, simpósios e similares</strong>
           </i>
           <p>
      ...
      <li>
       ...
       <p>
        ...
        <a
         href="https://www.bco.ufscar.br/arquivos/manual-bco-nbr-10520-2002.pdf"
         target="_blank"
     ...
     <ul>
      ...
      <li>
       ...
       <p>
        ...
        as submissões devem seguir o padrão descrito nas <Link to="#diretrizes">diretrizes para autores</Link>.
       </p>
      </li>
      <li>
       <h3>Entrevistas</h3>
       ...
       <p>
        ...
        uma apresentação do auto/temar da entrevista. O texto deverá conter a mesma formatação para artigos, descrita
        nas <Link to="#diretrizes">diretrizes para autores</Link>.
       </p>
      </li>
      <li>
       <h3>Traduções</h3>
      ...
      <li>
       ...
       <p>
        ...
        deve ter sido publicada há, no máximo, 5 anos, preferivelmente. Excessões serão consideradas e podem ser
        justificadas pela revelância da obra. Deve apresentar, além de uma descrição regular da obra, mas não
     ...
     <ol>
      <li>
       <span>
        ...
        <a href="https://creativecommons.org/licenses/by/4.0/">Creative Commons Attribution 4.0 International</a> (CC BY
        4.0).
       </span>
      </li>
      <li>
     ...
     <ol>
      ...
      <li>
       <span>
        ...
        oferecido um link para o <strong>OAI Identifier</strong> ou para o artigo que ele desceve, sob os termos da
