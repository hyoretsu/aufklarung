   ...
   <Styling>
    ...
    <section>
     ...
     <p>
      ...
      para dirimir a dúvida. Com base no resultado da avalição cega, a revista decide pela publicação ou não do artigo,
      ...
      convidados não são avaliados pelo sistema de avalição cega. Submissões reprovadas não poderão ser submetidas uma
    ...
    <section>
     ...
     <p>
      ...
      Aufklärung oferece acesso livre e irrestrito aos usuáros, não necessitando de cadastro prévio para leituras dos
    ...
    <section>
     ...
     <ul>
      <li>
       <a href="http://www.ojs.ufpi.br/index.php/pensando/issue/current/showToc">PENSANDO: Revista de Filosofia</a>
       <p>Mestrado em Ética e Epistemologia da UFPI</p>
       <p>ISSN 2178-843X</p>
      </li>
      <li>
       <a href="http://www.revistaclareira.com.br/index.php/clareira/index">
    ...
    <section>
     ...
     <p>
      Esta revista adere ao sistema <a href="http://www.ithenticate.com/">iThenticate</a> para verificar a autenticidade
      dos manuscritos a ela submetidos.
     </p>
    </section>
    <section>
     ...
     <p>
      ...
      <a href="https://doaj.org/bestpractice">princípios e boas práticas estabelecidos pelo DOAJ</a>.
     </p>
     <p>
    ...
    <section>
     ...
     <p>
      Área de classficiação da Revista (Principal): <strong>Filosofia [70100004 CAPES/CNPq]</strong>
     </p>
     <p>
     ...
     <p>
      ...
      <a href="https://sucupira.capes.gov.br/sucupira/public/consultas/coleta/veiculoPublicacaoQualis/listaConsultaGeralPeriodicos.jsf">
       Qualis
      </a>
      .
     </p>
    ...
    <section>
     ...
     <p>
      EM 2017/18 recebe apoio finaceiro de número [441153/2017-8], pela Chamada CNPq/CAPES No 26/2017 – Programa
      Editorial":
     </p>
     <ol>
      <li>
       ...
       <p>
        Visit at: <a href="http://www.cnpq.br/">cnpq.br</a>
       </p>
      ...
      <li>
       ...
       <p>
        Visit at: <a href="http://www.capes.gov.br/">capes.gov.br</a>
       </p>
      </li>
     </ol>
    </section>
