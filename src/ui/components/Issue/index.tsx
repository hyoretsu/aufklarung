...
const Issue: React.FC = () => {
    ...
    return (
        <Container>
            ...
            <Section>
                <p>
                    <Link href="/issues/19/articles/2">
            ...
            <Section>
                <p>
                    <Link href="/issues/19/articles/4">
            ...
            <Section>
                <p>
                    <Link href="/issues/19/articles/9">
            ...
            <Section>
                <p>
                    <Link href="/issues/19/articles/10">
                        A estética do movimento: uma leitura sartriana da psicoterapia a partir da arte de Alberto
                        Giacometti
                    </Link>
                </p>
                <div>
            ...
            <Section>
                <p>
                    <Link href="/issues/19/articles/12">
